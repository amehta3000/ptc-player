...
export class RidgeVisualizer extends BaseVisualizer {
  ...
  getPresets(): VisualizerPreset[] {
    return [
      { name: '1', config: { amplitude: 3.2, speed: 12, decay: 0.98, autoRotation: 0, zoomSpeed: 0, hue: 0, harmonyMode: 2 } },
      { name: '2', config: { amplitude: 2.0, speed: 5, decay: 1.0, autoRotation: 0, zoomSpeed: 0, hue: 0, harmonyMode: 1 } },
      { name: '3', config: { amplitude: 5.5, speed: 20, decay: 0.95, autoRotation: 0, zoomSpeed: 0, hue: 0, harmonyMode: 2 } },
      { name: '4', config: { amplitude: 3.5, speed: 12, decay: 0.98, autoRotation: 0.003, zoomSpeed: 0.005, hue: 0, harmonyMode: 1 } },
    ];
  }
