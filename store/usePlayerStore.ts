...
type VisualizerType = 'bars' | 'orb' | 'web' | 'terrain' | /* 'chrysalis' | */ 'sonicGalaxy' | 'constellation' | 'raindrops' | 'sacredGeometry' | 'cassette' | 'plasma' | 'radial' | 'spokes' | 'ripples' | 'ridge' | 'particleField' | 'bloom' | 'arcs';
...
export const VISUALIZER_TYPES: VisualizerType[] = ['terrain', 'bloom', 'radial', 'spokes', 'ridge', 'sonicGalaxy', 'constellation', 'particleField', 'orb', 'bars', /* 'plasma', 'web', 'chrysalis', */ 'arcs', 'raindrops', 'sacredGeometry'];
