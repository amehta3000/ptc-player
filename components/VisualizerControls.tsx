...
export default function VisualizerControls({
  ...
  return (
    <div className="absolute top-16 sm:top-20 right-2 sm:right-6 w-[calc(100vw-1rem)] sm:w-72 max-h-[60vh] sm:max-h-[70vh] overflow-y-auto p-3 sm:p-4 rounded-lg backdrop-blur-xl bg-black/60 border border-white/10 z-20 space-y-2.5 sm:space-y-3">
